...
public class PreAuthorizedCodeServiceTest {
    ...
    public void setup() throws Exception {
        ...
        ReflectionTestUtils.setField(preAuthorizedCodeService, "preAuthSubjectClaimKey", "");
    ...
    @Test
    public void exchangePreAuthorizedCode_SubjectClaimKeyUsedAsIdentityData() throws Exception {
        ReflectionTestUtils.setField(preAuthorizedCodeService, "preAuthSubjectClaimKey", "personId");
        ...
        Map<String, Object> claims = new HashMap<>();
        claims.put("personId", "PERSON-001");
        ...
        verify(accessTokenJwtUtil).generateSignedJwt(identityCaptor.capture(), anyString(), anyString(), anyString(), anyString(), anyInt(), anyString());
        Assert.assertEquals("PERSON-001", identityCaptor.getValue());
    }
