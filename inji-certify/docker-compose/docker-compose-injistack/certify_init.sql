...
-- Local person registry for PostgresDataProviderPlugin (no CSV / mock identity file)
CREATE TABLE IF NOT EXISTS certify.person_data (
...
INSERT INTO certify.person_data (person_id, full_name, date_of_birth, gender, email) VALUES
    ('PERSON-001', 'Ada Lovelace', '1815-12-10', 'Female', 'ada@example.local'),
    ('PERSON-002', 'Alan Turing', '1912-06-23', 'Male', 'alan@example.local'),
    ('PERSON-003', 'Grace Hopper', '1906-12-09', 'Female', 'grace@example.local')
...
VALUES (
    ...
    'active',
    '',
    NULL,  -- doctype from JSON
    NULL,  -- vct for SD-JWT VC
    'https://www.w3.org/2018/credentials/v1',
    'PersonCredential,VerifiableCredential',
    'ldp_vc',
    'did:web:localhost%3A8091',
    'CERTIFY_VC_SIGN_ED25519',
    'ED25519_SIGN',
    'EdDSA',
    'Ed25519Signature2020',
    NULL,
    '[{"name": "Person Verifiable Credential", "locale": "en", "logo": {"url": "https://mosip.github.io/inji-config/logos/agro-vertias-logo.png", "alt_text": "Person Credential"}, "background_color": "#12107c", "text_color": "#FFFFFF", "background_image": { "uri": "https://mosip.github.io/inji-config/logos/agro-vertias-logo.png" }}]'::JSONB,
    ARRAY['personId', 'fullName', 'dateOfBirth', 'gender', 'email'],
    'person_vc_ldp',
    ARRAY['did:jwk'],
    ARRAY['Ed25519Signature2020'],
    '{"jwt": {"proof_signing_alg_values_supported": ["RS256", "ES256"]}}'::JSONB,
    '{"personId": {"display": [{"name": "Person ID", "locale": "en"}]}, "fullName": {"display": [{"name": "Full Name", "locale": "en"}]}, "dateOfBirth": {"display": [{"name": "Date of Birth", "locale": "en"}]}, "gender": {"display": [{"name": "Gender", "locale": "en"}]}, "email": {"display": [{"name": "Email", "locale": "en"}]}}'::JSONB,
    NULL,
    '[]'::JSONB,
    ARRAY['revocation'],  -- credential_status_purpose
    '[{"Full Name": "${fullName}", "Email": "${email}"}]'::JSONB,
