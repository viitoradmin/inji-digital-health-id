...
public class GetWithParamForAutoGenId extends InjiCertifyUtil implements ITest {
	...
	public void test(TestCaseDTO testCaseDTO) throws AuthenticationTestException, AdminTestException, SecurityXSSException {
		...
		testCaseDTO = isTestCaseValidForExecution(testCaseDTO);
		...
		if (testCaseDTO.getTemplateFields() != null && templateFields.length > 0) {
			...
			response = getWithPathParamAndCookieForAutoGeneratedId(tempUrl + testCaseDTO.getEndPoint(), inputJson,
