...
public class VcDownloadAndVerifyUsingVidTest extends IosBaseTest {
    @Test
    public void downloadAndVerifyVcUsingVid() {
        ...
        otpVerification.enterOtp(InjiWalletUtil.getOtpForMock(), PlatformType.IOS);
    ...
    public void downloadTwoVcDeleteOneUsingVid() throws InterruptedException {
        ...
        assertTrue(retrieveIdPage.isRetrieveIdPageLoaded(), "Verify if retrieve id page is displayed");
        retrieveIdPage.clickOnVid(PlatformType.IOS).setEnterIdTextBox(vid).clickOnGenerateCardButton();
    ...
    public void verifyInvalidVidErrorMessage() {
        ...
        assertTrue(retrieveIdPage.isRetrieveIdPageLoaded(), "Verify if retrieve id page is displayed");
        retrieveIdPage.clickOnVid(PlatformType.IOS).setEnterIdTextBox("00").clickOnGenerateCardButton();
    ...
    public void downloadAndVerifyVcUsingRevokeVid() {
        ...
        assertTrue(retrieveIdPage.isRetrieveIdPageLoaded(), "Verify if retrieve id page is displayed");
        OtpVerificationPage otpVerification = retrieveIdPage.clickOnVid(PlatformType.IOS).setEnterIdTextBox(TestDataReader.readData("revokevid")).clickOnGenerateCardButton();
