...
public class SimplePostForAutoGenIdForUrlEncoded extends InjiVerifyUtil implements ITest {
	...
	public void test(TestCaseDTO testCaseDTO)
		...
		String jsonInput = inputJsonModuleKeyWordHandler(inputJson, testCaseName);

		response = postWithBodyAndCookieForAutoGeneratedIdForUrlEncoded(injiVerifyBaseUrl + testCaseDTO.getEndPoint(),
